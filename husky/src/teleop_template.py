...
if __name__=="__main__":
    ...
    pub_moveR = rospy.Publisher('/husky/wheel_BR_controller/command', Float64, queue_size=10) # Add your topic for move here '' Eg '/my_robot/longitudinal_controller/command'
    ...
    try:
        ...
        while(1):
            ...
            pub_moveR.publish(control_speed) # publish the control speed. 
